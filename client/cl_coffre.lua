        ...
        CreateThread(function()
            while open do 
                RageUI.IsVisible(MenuCoffreLTD, function()
                    RageUI.Separator("↓     ~p~Coffre     ~p~↓")
                    RageUI.Button("Prendre", nil, {RightLabel = "~p~→→→"}, true, {
                        onSelected = function() 
                            OpenPrendreLTDMenu()
                            RageUI.CloseAll()
                        end
                    ...
                    RageUI.Button("Déposer", nil, {RightLabel = "~p~→→→"}, true, {
                        onSelected = function() 
                            OpenDeposerLTDMenu()
                            RageUI.CloseAll()
                        end
                    ...
                    RageUI.Separator("↓     ~r~Fermeture     ~p~↓")
                    RageUI.Button("~r~Fermer", nil, {RightLabel = "~p~→→"}, true, {
                        onSelected = function() 
                            RageUI.CloseAll()
                        end
                    })
